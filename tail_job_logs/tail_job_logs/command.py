...
class ArgumentParser(argparse.ArgumentParser):
    def __init__(self):
        ...
        self.add_argument(
            '--task', '-t', action='store',
            help='Only include logs from specified task')
        self.add_argument(
            '--ignore-regex', action='store',
            help='Skip logs generated by the job matching that regex')
        self.add_argument(
...
class Command(object):
    ...
    def run(self):
        kwargs = {
            ...
            'task': self.args.task,
            'ignore_regex':self.args.ignore_regex,
        }
        if self.args.job:
